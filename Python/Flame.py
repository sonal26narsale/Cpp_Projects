...
def tell_status() :
    ...
    result = ["Friends forever","loyalty ","Adoration","Mutual Attachment","Enemy"]
...
if __name__ == "__main__" :
    ...
    label3 = Label(root, text = "Friendship Status: ",
    fg = 'black', bg = 'light blue')
    ...
    Player1_field.grid(row = 1, column = 1, ipadx ="150")
    Player2_field.grid(row = 2, column = 1, ipadx ="150")
    Status_field.grid(row = 4, column = 1, ipadx ="150")


    button1 = Button(root, text = "Submit", bg = "light green",
