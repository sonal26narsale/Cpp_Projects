...
contact:
    ...
    {
        cout << "\t\t\t Please try to Enter only 10 Digits..." << endl;
        goto contact;
    }
    cout << "\t\t\tEnter Address: ";
    cin >> address;
...
void student::modify()
{
    ...
    {
        cout << "\nEnter the Roll No. of Student which you wanted to Modify: ";
        cin >> rollno;
...
void student::search()  
{
    ...
    else
    {
        ...
        cout << "\nEnter the Roll No. of Student which you wanted to search: ";
        cin >> rollno;
        file >> name >> roll_no >> course >> email_id >> contact_no >> address;
        while (!file.eof())
        {
...
void student::deleted()
{
    ...
    {
        cout << "\nEnter the Roll No. of Student which you wanted Delete Data: ";
        cin >> roll;
        file1.open("record.txt", ios::app | ios::out);
        file >> name >> roll_no >> course >> email_id >> contact_no >> address;
        while (!file.eof())
